...
const Navbar = () => {
    return (
        <div className="w-full fixed top-0 px-20 py-4 pt-6 font-['Neue_Montreal'] flex justify-between bg-['#18181b'] backdrop-blur-md z-[9]">
            <div className="logo">
                <svg
                    width="72"
                    height="30"
            ...
            <div className="links flex gap-[2.5rem]">
                {[
                    "Services",
                    "Our Work",
                    "About Us",
